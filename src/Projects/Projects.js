    ...
    return (
      <div className="page">
        <div className="current">
          ...
          <ProjectCard title="Micro Cloud" featuredImage={mc} description="Content Management System (CMS) for Micro Map applications.  API utilizes Node, Express, Mongo, Mongoose.  Interface utilizes React framework." />
